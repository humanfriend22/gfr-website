        ...
        <div class="flex flex-col gap-5 px-5 pt-5">
            <div class="flex flex-row justify-between">
                <div class="flex flex-row gap-4">
                    <NuxtImg src="KLogo.png" class="w-48 h-48 rounded-md bg-black" />
                    <div class="h-fit">
                        <div class="font-bold text-7xl">Kreamers</div>
                        <h3 class="text-gray-500 text-2xl">Eric Tao & Jack Wu</h3>
                    </div>
                </div>
                <div class="flex flex-col justify-start">
                    <div class="flex items-center gap-3.5">
                        ...
                        <div class="relative w-9 h-9 cursor-pointer">
                            <NuxtImg src="/instagram.svg" class="w-9 absolute" />
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram w-9 absolute hover:opacity-0 opacity-100 text-gray-300 duration-300" viewBox="0 0 16 16">
                                <path
            ...
            <div class="grid grid-cols-6 gap-5">
                <div class="p-5 flex flex-col justify-center items-center gap-2 bg-zinc-900 rounded-lg" v-for="i in Array(15)">
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-5">
                    <div v-for="i in Array(10)" class="p-4 bg-zinc-900 rounded-lg flex flex-col gap-2">
